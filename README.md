...
---
### Admin
- First admin will login ( for username/password run following command in your terminal )
```
...
- if customer is deleted by admin then their request will be deleted automatically
